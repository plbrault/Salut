...
def get_admin_error_message(request):
    ...
    if "admin_password" in config:
        return "Set a value for <code>admin_password</code> in <code>secrets.yml</code> to enable the admin page."
    return "Set <code>admin_password</code> in your config to enable the admin page."
